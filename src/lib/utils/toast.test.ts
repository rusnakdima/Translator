...
describe('ToastHelper', () => {
  ...
  describe('show', () => {
    it('should call info on service when type is info', () => {
      ...
      expect(mockService.info).toHaveBeenCalledWith('hello', { duration: 3000 });
    });
    ...
    it('should call success on service when type is success', () => {
      ...
      expect(mockService.success).toHaveBeenCalledWith('done', { duration: 2000 });
    });
    ...
    it('should call error on service when type is error', () => {
      ...
      expect(mockService.error).toHaveBeenCalledWith('failed', { duration: 5000 });
    });
