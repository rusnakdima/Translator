...
const translations: Record<Locale, TranslationDict> = {
  en: {
    ...
    "about.aboutText":
      "A free and open source translation application powered by LibreTranslate. Supports multiple languages with offline capabilities.",
  ...
  ru: {
    ...
    "settings.translationDesc":
      "Используется API LibreTranslate для перевода текста",
    "settings.version": "Версия",
    "about.title": "О приложении",
    "about.description": "О приложении",
    "about.aboutText":
      "Бесплатное приложение для перевода с открытым исходным кодом на базе LibreTranslate. Поддерживает несколько языков с возможностью офлайн работы.",
