...
import { sourceLang, targetLang, appLocale, swapLanguages } from './globalState';
...
describe('globalState store', () => {
  ...
  describe('sourceLang', () => {
    ...
    it('should notify subscribers on change', () => {
      let received = '';
      const unsubscribe = sourceLang.subscribe((v) => { received = v; });
      sourceLang.set('fr');
  ...
  describe('targetLang', () => {
    ...
    it('should notify subscribers on change', () => {
      let received = '';
      const unsubscribe = targetLang.subscribe((v) => { received = v; });
      targetLang.set('de');
